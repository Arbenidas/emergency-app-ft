                  ...
                  child: Column(
                    children: [
                      ...
                      DefaultTextFieldOutlined(
                        ...
                        margin: EdgeInsets.only(left: 50, right: 50, top: 15),
                        onChanged: (text) {
                          context.read<RegisterBloc>().add(PasswordChange(password: Blocformitem(value: text)));
                        },
                        validator: (value) {
                      ...
                      DefaultTextFieldOutlined(
                        ...
                        margin: EdgeInsets.only(left: 50, right: 50, top: 15),
                        onChanged: (text) {
                          context.read<RegisterBloc>().add(ConfirmPasswordChange(confirmpassword: Blocformitem(value: text)));
                        },
                        validator: (value) {
